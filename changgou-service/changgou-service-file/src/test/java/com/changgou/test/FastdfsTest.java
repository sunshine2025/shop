...
public class FastdfsTest {
    private static String conf = "D:\\work\\WorkSpace\\changgou\\changgou-parent\\changgou-service\\changgou-service-file\\src\\main\\resources\\fdfs_client.conf";
    ...
    public void upload() throws Exception {
        ...
        String[] jpgs = storageClient.upload_file("D:\\work\\RE\\changgou\\study\\img\\40.jpg", "jpg", null);
    ...
    public void download() throws Exception {
        ...
        //参数1:指定组名
        //参数2 :指定远程的文件名
        byte[] bytes = storageClient.download_file("group1", "M00/00/00/rBUABF6oEzSAI3FqAAFANx5ocDo629.jpg");

        //写流
        FileOutputStream fileOutputStream = new FileOutputStream(new File("D:/work/RE/changgou/study/img/12345678.jpg"));
    ...
    public void delete() throws Exception {
        ...
        int group1 = storageClient.delete_file("group1", "M00/00/00/rBUABF6oEzSAI3FqAAFANx5ocDo629.jpg");
        if (group1 == 0) {
    ...
    public void getFileinfo() throws Exception{
        ...
        //参数1 指定组名
        //参数2 指定文件的路径
        FileInfo fileInfo = storageClient.get_file_info("group1", "M00/00/00/rBUABF6oEzSAI3FqAAFANx5ocDo629.jpg");
    ...
    public void getserverinfo() throws Exception{
        ...
        ServerInfo[] group1s = trackerClient.getFetchStorages(trackerServer, "group1", "M00/00/00/rBUABF6oEzSAI3FqAAFANx5ocDo629.jpg");
